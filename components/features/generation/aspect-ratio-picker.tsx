...
import { CaretUp, FrameCorners } from "@phosphor-icons/react/dist/ssr";
...
const RATIOS = ["1:1", "16:9", "9:16", "3:2", "2:3", "4:5", "5:4"];
...
export function AspectRatioPicker({ value, onChange }: Props) {
  ...
  return (
    <div ref={ref} style={{ position: "relative" }}>
      ...
      >
        <FrameCorners size={14} style={{ color: "rgba(255,255,255,0.4)" }} />
