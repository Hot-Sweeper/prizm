...
export const IMAGE_MODELS: Record<string, ModelInfo> = {
  ...
  // ── Google / Gemini ─────────────────────────────────
  "gemini-3.1-flash-image-preview": { displayName: "Nano Banana 2", provider: "Google", familyKey: "google", creditCost: 3, minTier: "max", description: "Gemini image stack with strong consistency and 4K-ready output", estimatedCostUSD: 0.03, pricingLabel: "$0.40/M in • $2.40/M out", transport: "gemini-image", directOnly: true },
