...
export const IMAGE_MODELS: Record<string, ModelInfo> = {
  ...
  "nano-banana-2": { displayName: "Nano Banana 2", provider: "Google", familyKey: "google", creditCost: 1, minTier: "pro", description: "Gemini standard generation", estimatedCostUSD: 0.015, pricingLabel: "Fast", transport: "gemini-image", directOnly: true },
