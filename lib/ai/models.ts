...
export const IMAGE_MODELS: Record<string, ModelInfo> = {
  ...
  // ── Google / Gemini ─────────────────────────────────
  "gemini-3.1-flash-image-preview": { displayName: "Nano Banana Pro", provider: "Google", familyKey: "google", creditCost: 3, minTier: "max", description: "Gemini image stack with extreme definition", estimatedCostUSD: 0.03, pricingLabel: "$0.40/M in • $2.40/M out", transport: "gemini-image", directOnly: true },
  "gemini-3.1-8b-image-preview": { displayName: "Nano Banana 2", provider: "Google", familyKey: "google", creditCost: 1, minTier: "pro", description: "Gemini standard generation", estimatedCostUSD: 0.015, pricingLabel: "Fast", transport: "gemini-image", directOnly: true },
